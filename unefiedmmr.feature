...
Feature: Unified Mrr
    ...
    Scenario: Create A New Member
        ...
        Then Enter data in Add Member Page with all details
            ...
            | MMR  | AUTO  | MEMBER1 | MMRAUTO.MEMBER1@mindoula.com | Mobile | Member    | 2125618000 | 01/31/1958 | Living with parents/caregiver/family member | None                  | Male   | Single         | 11529 170th St Jamaica NY, 11434, USA | 2125618001 | 2125618002   | REG   | Male            | He/Him  | Asexual            | Annulled       | Arabic           | Pacific Time (US & Canada) | Declined to Specify | Asian | Cold Referral | Email       | Yes  | Yes   | Yes   | has curly hair and is tanned. |
